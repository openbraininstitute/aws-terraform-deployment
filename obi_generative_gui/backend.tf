...
resource "aws_vpc_security_group_ingress_rule" "obi_generative_gui_allow_container_port" {
...
resource "aws_vpc_security_group_egress_rule" "obi_generative_gui_allow_outgoing" {
  security_group_id = aws_security_group.obi_generative_gui_ecs_task.id
  ...
  tags = {
    ...
    Name        = "obi_generative_gui_allow_outgoing"
  }
}
